package src.Lesson7_LinkedList;

import java.util.LinkedList;

public class LinkedListExample1 {
    public static void main(String[] args) {
        Student2 st1 = new Student2("Kamal", 2);
        Student2 st2 = new Student2("Yusif", 2);
        Student2 st3 = new Student2("Medina", 3);
        Student2 st4 = new Student2("Ferid", 2);
        Student2 st5 = new Student2("Rustam", 3);
        ...
        Student2 st6 = new Student2("Ayxan", 2);
        Student2 st7 = new Student2("Qasan", 3);
